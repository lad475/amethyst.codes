<template>
  <ame-content-box>
    ...
    <ame-project-box name="PalmTree Website"
                     ...
                     link-title="Website (Hosted on GitHub Pages)"/>
    <ame-project-box name="PalmTree APIs"
                     ...
                     link-title="View project on GitHub"/>
    <ame-project-box name="StackIt!"
                     ...
                     link="Coming soon to iOS and Android!"/>
    <ame-project-box name="MyBuddy"
                     ...
                     link=""
                     link-title="MyBuddy Site (Hosted on GitHub pages)"/>
